...
it('redirects to background image URL for general endpoint', function () {
	...
	get('/api/v1/unsplash/image/general?collections=ID1,ID2')
...
it('returns JSON mode when requested', function () {
	...
	get('/api/v1/unsplash/image/general?collections=ID1,ID2&response=json')
		->assertOk()
...
it('redirects to seasonal background when mapping exists', function () {
	...
	get('/api/v1/unsplash/image/seasonal?season=spring')
