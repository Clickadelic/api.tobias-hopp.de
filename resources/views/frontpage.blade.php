...
@section('content')
    <div class="bg-white/50 shadow backdrop-blur mx-auto p-2 rounded max-w-lg">
        <div class="flex flex-col justify-center items-center bg-gray-900 px-12 py-6 md:py-12 rounded">                       
            ...
            <p class="text-gray-400 text-sm text-center">This API provides access &shy;to various <br>features and functionalities &shy;of Toby's platform.</p>
            <div class="flex justify-center items-center gap-4 text-center">
                <code class="block mt-3 sm:mt-5 w-37.5 sm:w-55 md:w-88.75 text-gray-300 text-xs sm:text-sm md:text-base text-center">https://api.tobias-hopp.de/up</code>
