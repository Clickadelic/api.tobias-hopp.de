...
@section('content')
	...
	<div class="border-2 border-primary shadow backdrop-blur mx-auto rounded max-w-lg flex flex-col justify-center items-center bg-gray-900 px-12 py-6 md:py-12">
		<div class="flex flex-col justify-center items-center bg-gray-900 px-12 py-6 md:py-12 rounded">                       
			...
			<div class="flex justify-center items-center gap-4 text-center">
				<code class="block mt-3 sm:mt-5 w-37.5 sm:w-55 md:w-88.75 text-gray-300 text-xs sm:text-sm md:text-base text-center">
					<a href="https://api.tobias-hopp.de/up" target="_blank" class="hover:underline">https://api.tobias-hopp.de/up</a>
				</code>
			</div>
		</div>
	</div>
