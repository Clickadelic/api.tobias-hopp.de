...
@section('content')
    ...
    <section id="backgrounds" class="mb-8">
        ...
        <p class="text-gray-300">Public endpoints that select an Unsplash image and redirect to the image URL (or return
        ...
        <pre class="bg-black/40 text-gray-200 p-3 rounded overflow-x-auto">
				<code>
					UNSPLASH_COLLECTION_SPRING_ID=
					UNSPLASH_COLLECTION_SUMMER_ID=
					UNSPLASH_COLLECTION_AUTUMN_ID=
					UNSPLASH_COLLECTION_WINTER_ID=
				</code>
			</pre>
        <p class="text-gray-300">Query params:</p>
        <ul class="list-disc list-inside text-gray-300">
        ...
        <p class="text-gray-300">Each selection registers a download with Unsplash (best-effort) to comply with API
            guidelines. JSON responses include <code>photo.user</code> for attribution.</p>
    </section>
    ...
    <section id="notes" class="mb-8">
        ...
        <ul class="list-disc list-inside text-gray-300">
            ...
            <li>When not passing any collections to the general endpoint, the app uses <code>UNSPLASH_COLLECTION_IDS</code>
