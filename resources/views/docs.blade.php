...
@section('content')
        ...
        <section id="backgrounds" class="mb-8">
            ...
            <pre class="bg-black/40 text-gray-200 p-3 rounded overflow-x-auto">
				<code>curl "http://127.0.0.1:8000/api/background/general?collections=ID1,ID2&variant=raw&w=1920&q=80" -I
				</code>
			</pre>

            <p class="mt-3 text-gray-300">JSON mode:</p>
            <pre class="bg-black/40 text-gray-200 p-3 rounded overflow-x-auto">
				<code>curl "http://127.0.0.1:8000/api/background?collections=ID1,ID2&response=json&variant=full&w=2560&q=75"</code></pre>
            ...
            <pre class="bg-black/40 text-gray-200 p-3 rounded overflow-x-auto">
				<code># Auto-detect season in Europe/Berlin, daily-stable selection
					...
					curl "http://127.0.0.1:8000/api/background/seasonal?season=autumn&variant=raw&w=1920&q=80" -I
				</code>
			</pre>
